...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Heartland Community Foundation. We\'d love to hear from you about grants, giving, or community programs.',
  keywords: ['Contact Heartland Community Foundation', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about grants, giving, or community programs? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@heartlandcf.org</p>
                    <p className="text-gray-600">support@heartlandcf.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 345-6701</p>
